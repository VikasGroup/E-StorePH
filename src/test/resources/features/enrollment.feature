...
@Reg
Scenario Outline: Companyregistration
Given user open the login page 
When user click on Register button
And preregister page should displayed with pop up window "<urlprereg>"
And  Enter "<IRID>" of referrer
...
And then Confirm button
And validate registation page "<urlreg>"
And  Fill up the company registration form and agree to the terms in enrollment
And  Fill up placement information
And  Choose enrolment package
Then Select Payment "<Option>"
And Enter payment details 
...
Examples:
|urlprereg|language|IRID|country|enrolmenttype|urlreg|Option|
|https://portal.qntest.com/eStore/preregister.aspx?referrer=|2|hu041741|Azerbaijan||https://portal.qntest.com/eStore/registercompany.aspx|euro|
|https://portal.qntest.com/eStore/preregister.aspx?referrer=|3|hu041741|Cote D'Ivoire||https://portal.qntest.com/eStore/registercompany.aspx|us|
|https://portal.qntest.com/eStore/preregister.aspx?referrer=|4|hu041741|Ethiopia||https://portal.qntest.com/eStore/registercompany.aspx|euro|
|https://portal.qntest.com/eStore/preregister.aspx?referrer=|9|hu041741|Georgia||https://portal.qntest.com/eStore/registercompany.aspx|us|
|https://portal.qntest.com/eStore/preregister.aspx?referrer=|2|hu041741|Libya||https://portal.qntest.com/eStore/registercompany.aspx|us|
