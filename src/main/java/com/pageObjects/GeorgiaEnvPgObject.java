...
public class GeorgiaEnvPgObject extends BasicPageObject{
	...
	static WebDriver driver;
	 public Base base;
	 public GeorgiaEnvPgObject( WebDriver driver){
		 super(driver);
		 GeorgiaEnvPgObject.driver=driver;	 
	 }
	 ...
	 public void selectRelationship(String value){
		 Select relationship=new Select(dobyear_dp);
