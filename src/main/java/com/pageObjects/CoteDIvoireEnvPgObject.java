...
public class CoteDIvoireEnvPgObject extends BasicPageObject{
	...
	public WebElement confirm_btn = createElement(By.xpath(".//*[@id='cmdOK']"));
	 ...
	 public Base base;
	 public CoteDIvoireEnvPgObject( WebDriver driver){
		 super(driver);
		 CoteDIvoireEnvPgObject.driver=driver;	 
	 }
		 ...
		 public void selectTown(String value){
			 Select town= new Select(town_txt);
