...
public class HongKongEnvPgObject extends BasicPageObject  {
	...
	public  WebElement ans_tx			= createElement(By.xpath(".//*[@id='SecurityQuestions_IRAnswer1']"));
	public  WebElement secword_tx		=createElement(By.xpath(".//*[@id='SecurityQuestions_SecWord']"));
	...
	public void selectTitle(String value){
	 ...
	 public void enterAnswer(String value){
		 ans_tx.sendKeys(value);
	 }
	 public void enterSecword(String value){
		 secword_tx.sendKeys(value);
	 }
