...
public class IraqEnvPgObject extends BasicPageObject{
	...
	static WebDriver driver;
	 public IraqEnvPgObject( WebDriver driver){
		 super(driver);
	 ...
	 public void selectTitle(String value){
		 ...
		 public void enterTown(String value){
				 Select enterTown= new Select(town_dp);
				 enterTown.selectByIndex(Integer.parseInt(value));
		 }
