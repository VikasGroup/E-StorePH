package com.pageObjects.Company;
...
public class SyrianArabrepublicEnvComPgObj {
	
		 WebDriver driver;
		 public Base base;
		 
		 public SyrianArabrepublicEnvComPgObj( WebDriver driver){
			 this.driver=driver;	 
		 }
	...
	public void enterComName(String value){
	 ...
	 public void selectTown(String value){
		 Select town =new Select(driver.findElement(By.xpath(".//*[@id='ddlOccupation']")));
