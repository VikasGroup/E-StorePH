...
public class AzerbaijanEnvComPgobj {
	WebDriver driver;
	 public Base base;
	 
	 public AzerbaijanEnvComPgobj( WebDriver driver){
		 this.driver=driver;	 
	 }
	 ...
	 public void enterBeName(String value){
		 WebElement beName=driver.findElement(By.xpath(".//*[@id='tbLeaderName']"));
		 beName.sendKeys(value);
	 }
