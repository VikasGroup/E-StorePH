...
public class SyrianArabRepublicEnvPgObject {
	 WebDriver driver;
	 public Base base;
	 ...
	 public void enterHomePhonePrefix(String value){
		 WebElement homephoneprefix=driver.findElement(By.xpath(".//*[@id='tbHomeCountryHomeTelPrefix']"));
		 homephoneprefix.sendKeys(value);                       
	 }
	 ...
	 public void selectAgreement(){
		 ...
		 WebElement chk7=driver.findElement(By.xpath(".//*[@id='chkSYPhone']"));
		 chk1.click();
		 chk2.click();
		 chk3.click();
		 chk4.click();
