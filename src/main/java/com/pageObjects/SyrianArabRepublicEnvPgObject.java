...
public class SyrianArabRepublicEnvPgObject extends BasicPageObject{
	...
	public WebElement town_dp = createElement(By.xpath(".//*[@id='ddlCity']"));
	public WebElement post_txt = createElement(By.xpath(".//*[@id='txtPostZip']"));
	public WebElement phoneprefix_txt = createElement(By.xpath(".//*[@id='tbHomeCountryHomeTelPrefix']"));
	...
	public WebElement chk7_c1 = createElement(By.xpath(".//*[@id='chkSYPhone']"));
	public WebElement confirm_btn = createElement(By.xpath(".//*[@id='cmdOK']"));
	
	
	static WebDriver driver;
	 public Base base;
	 public SyrianArabRepublicEnvPgObject( WebDriver driver){
		 super(driver);
		 SyrianArabRepublicEnvPgObject.driver=driver;	 
	 }
	 ...
	 public void selectTown(String value){
		 Select town= new Select(town_dp);
		 town.selectByIndex(Integer.parseInt(value));
	 }
	 public void enterPostal(String value){
		 post_txt.sendKeys(value);
	 }
	 public void enterHomePhonePrefix(String value){
		 phoneprefix_txt.sendKeys(value);                       
	 }
